...
int main() {
    ...
    // Current Player should get 3 cards
    printf("Current Player gained 3 cards\n");
    printf("Hand Count = %d, Expected = %d\n", testState.handCount[0], state.handCount[0] + 3 - discard);
    assertTrue(testState.handCount[0], state.handCount[0] + 3 - discard);
    
    // Check the current player's Deck Count
    printf("Deck Count = %d, Expected = %d\n", testState.deckCount[0], state.deckCount[0] - 3);
    assertTrue(testState.deckCount[0], state.deckCount[0] - 3);
